...
in
{
  ...
  my.monitors = [
    ...
    { name = "DP-3"; width = 2560; height = 1440; refresh = 99.946; x = 1152; y = centerY 1152; scale = 1.25; primary = true; vendor = "DEL"; product = "DELL P2425D"; serial = "76X00C4"; }
    { name = "DP-1"; width = 1920; height = 1080; refresh = 60.0; x = 3200; y = centerY 1080; scale = 1.0; vendor = "MSI"; product = "MSI MAG241C"; serial = "0x000001e0"; }
  ];
